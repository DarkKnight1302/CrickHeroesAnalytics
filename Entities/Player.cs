...
namespace CricHeroesAnalytics.Entities
{
    public class Player
    {
        ...
        public string? PlayerProfilePic { get; set; } = "https://media.cricheroes.in/default/user_profile.png";
        ...
        public int Boundaries => fours + sixes;

        public DateTime LastMatchUpdated { get; set; } = DateTime.MinValue;
